...
all: pipeline tests benchmarks crossover
...
cpu_test: $(BIN_DIR) $(BUILD_DIR) $(BUILD_DIR)/cpu_filters.o
	$(CXX) $(CXXFLAGS) -DNO_CUDA tests/cpu_test_runner.cpp src/dispatch.cpp $(BUILD_DIR)/cpu_filters.o -o $(BIN_DIR)/cpu_test
...
pipeline: $(BIN_DIR) $(BUILD_DIR)/cpu_filters.o $(BUILD_DIR)/gpu_filters.o
	$(NVCC) $(NVCCFLAGS) src/main.cpp src/dispatch.cpp $(BUILD_DIR)/cpu_filters.o $(BUILD_DIR)/gpu_filters.o -o $(BIN_DIR)/pipeline
